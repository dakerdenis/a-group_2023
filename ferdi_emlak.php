...
<style>
    <?php
    include './styles/ferdi_emlak.css';
    ?>
</style>
...
<div class="main__wrapper">
    ...
    <div class="ferdi_emlak_container">
        ...
        <div class="ferdi__emlak__name-desc">
            <p>
                Əmlakınızı sığortalamağın <span>ƏSL</span> vaxtıdır!
            </p>
        </div>
        <div class="ferdi__emlak__name-text">
            <p>
                Könüllü əmlakın sığortası - əmlakınızı qorumağın və böyük maliyyə itkilərinin qarşısını almağın ən yaxşı yoludur.
            </p>
        </div>


        <!----------------->
        <div class="ferdi__emlak__content-container">
